...
out VertexOutput
{
	vec3 WorldPosition;//顶点的世界空间位置
    vec3 Normal;//定义切线空间中的Normal?
	vec2 TexCoord;//uv
	mat3 WorldNormals;//世界切线空间
} vs_Output;
...
// PBR texture inputsu_EnvRadianceTex
...
void main()
{
	...
	// Specular reflection vector glm::reflect()
